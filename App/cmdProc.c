...
bool cmdPGA_wr(void)
{
	...
	if (ads1255_SetPGAGain(pgaVal) != PASS)
	{
		retval =  false;
	}
	else
...
bool cmdSaveDeviceSerialNo_wr(void)
{
	...
	goldenCfg.scanCfg.wavelength_start_nm = 900;
	goldenCfg.scanCfg.wavelength_end_nm = 1700;
	...
	HadamardCfg.scanCfg.wavelength_start_nm = 900;
