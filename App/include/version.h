...
#define TIVA_VERSION_MINOR 0
#define TIVA_VERSION_BUILD 1
 ...
 * 2.0.0 - Keeping the scan button pressed at EVM start-up will skip setting the
         ...
         - Capability to set any selected Configuration on EVM as the default configutartion.
         ...
         - Slew Scan capability added.Capability to support different exposure times for different sections.
